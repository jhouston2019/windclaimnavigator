#!/usr/bin/env python3
"""
PDF Batch Processor - Add Watermarks and Password Protection
This script processes all PDFs in a folder, adding watermarks and password protection.
"""
...
# Paths
INPUT_FOLDER = "./docs"  # Folder containing your original PDFs
OUTPUT_FOLDER = "./docs/protected"  # Where to save protected PDFs
...
# Password Settings
USER_PASSWORD = "Claim Navigator2025"  # Password to open the document
OWNER_PASSWORD = "AdminClaimNav2025"  # Password for permissions (should be different)
