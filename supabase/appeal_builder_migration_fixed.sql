-- Fixed Appeal Builder Database Setup
...
-- 6. Handle transactions table - add missing columns if they don't exist
DO $$ 
BEGIN
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE transactions ADD COLUMN payout_status text DEFAULT 'pending';
    END IF;
    ...
    IF NOT EXISTS (
        ...
        ALTER TABLE transactions ADD COLUMN affiliateid text;
    END IF;
END $$;
